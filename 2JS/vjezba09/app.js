...
// funkcija je skup naredbi s odreženom svrhom, s ciljem višestrukog poziva -> DRY

// osnovne vrste funkicja
...
function pozdraviSvijet(){ // ne prima parametre jer u zagradama () nema teksta
   // tijelo funkcije
...
function slucajniBroj(odBroja=0,doBroja=0){ // opcijnalni parametri
...
// arrow funkcije
const podzravArrow = () => log('Hello arrow');
